            ...
            <>
              <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ fontSize: '.83rem', color: '#6B7280', margin: 0 }}>
                  ...
                  <strong style={{ color: '#1B4332' }}>{emailFromQuery}</strong>
                </p>
              </div>

              <form onSubmit={handleVerifyOtp} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '.78rem', fontWeight: 600, color: '#374151', marginBottom: '.75rem' }}>
                    Kode Verifikasi
                  </label>
                  ...
                  <p style={{ fontSize: '.75rem', color: '#9CA3AF', textAlign: 'center', marginTop: '.6rem' }}>
